    ...
    <main style="background-color: rgb(240, 234, 234);">
        <div class="d-flex flex-column min-vh-100 justify-content-center align-items-center">
            <div class="shadow p-5 mb-5 bg-body rounded-3 text-center" style="width: 30%;">
                ...
                <form action="editar-aluno.php" method="post" class="text-start">
                    <div class="mb-3">
                        <input type="hidden" class="form-control item" id="inputId" name="txtId" value="<?= $aluno['id'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="inputNome" class="form-label">Nome</label>
                        <input type="text" class="form-control item" id="inputNome" name="txtNome" value="<?= $aluno['nome'] ?>" aria-describedby="nomeDesc" required>
                        <div id="nomeDesc" class="form-text">Informe seu nome.</div>
                    </div>
                    <div class="mb-3">
                        <label for="inputEmail" class="form-label">E-Mail</label>
                        <input type="email" class="form-control item" id="inputEmail" name="txtEmail" value="<?= $aluno['email'] ?>" aria-describedby="emailDesc" required>
                        <div id="emailDesc" class="form-text">Informe seu email.</div>
                    </div>
                    <div class="mb-3">
                        <label for="inputTelefone" class="form-label">Telefone</label>
                        <input type="tel" class="form-control item" id="inputTelefone" name="txtTel" value="<?= $aluno['telefone'] ?>" data-mask="00 0000#-0000" data-mask-reverse="true" aria-describedby="TelDesc" required>
